...
* The Golden Rule: Make everything LAZY by default on your entities. Never define FetchType.EAGER on the entity class itself. Instead, hydrate the relationships dynamically exactly when you need them using JOIN FETCH or @EntityGraph at the repository layer. This ensures your entities stay lightweight for simple updates.
